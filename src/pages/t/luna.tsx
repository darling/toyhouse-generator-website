		...
		>
			<Formik
				initialValues={{
					...
					residence: 'Residence',
					summary: 'Insert cool text here :)',
					backstory: 'Insert cool text here :)',
					personality: 'Insert cool text here :)',
					photos: {
										...
										<Disclosure key={key}>
											{({ open }) => (
												<>
													...
													<Disclosure.Panel>
														<div className="tw-grid tw-grid-cols-2 md:tw-grid-cols-4 lg:tw-grid-cols-6 tw-gap-x-4">
															<FormInput
							...
							<div className="container p-0 w-100">
								...
								<div className="row no-gutters">
									...
									>
										<a
											href={
												values.relationships.three.link
											}
										>
											<div className="text-right p-1 bg-left bg-faded text-faded">
												<h3>
									...
									>
										<a
											href={
												values.relationships.four.link
											}
										>
											<div className="text-right p-1 bg-left bg-faded text-faded">
												<h3>
